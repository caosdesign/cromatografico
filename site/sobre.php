...
<!-- Marcação de microdados adicionada pelo Assistente de marcação para dados estruturados do Google. -->
  ...
  <body role="document" id="about-page">
    ...
    <section itemscope itemtype="http://schema.org/Article" class="wrap">
      <header class="text-center">
        ...
        <div id="social-container">
          <ul class="share-buttons">
            ...
            <li><a href="https://twitter.com/intent/tweet?source=http%3A%2F%2Fwww.engenhoca.caosdesign.com.br%2Fcromatografico%2F&text=descubra%20a%20cor%20das%20palavras%20no%20cromatogr%C3%A1fico%20-%20http%3A%2F%2Fbit.ly%2Fcromatografico%2F&via=caosdesign" target="_blank" title="Tweet"><i class="fa fa-twitter"></i></a></li>
      ...
      <meta itemprop="url" content="http://www.engenhoca.caosdesign.com.br/cromatografico/sobre.html">
    </section>

    <footer class="footer">
      <div class="container um texto">
        <p>
          <span>e</span>
          <span>n</span>
          <span>g</span>
    ...
    <script type="text/javascript">
      ...
      (function () {
        ...
        $(document).ready(function () {
          ...
          var getFonts = './components/marca/fontes.json';
